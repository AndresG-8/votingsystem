...
class Node(models.Model):
    ...
    public_key = models.TextField() # llave pública que puede ser consultada por cualquiera, se hace con la clave del usuario nodo y el node_id
    private_key = models.TextField() # podría recrearse solo en tiempo de ejecución, cuando el nodo esté funcionando, se hace con la clave del usuario nodo y el node_id
